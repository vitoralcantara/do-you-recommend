...
<body>
	<div class="pb-2 mt-4 mb-4 border-bottom title">
		<label class="lb-lg">Alterar horário</label>
	...
	<div class="col-md-8  justify-content-center titleLike">
		...
		<label class="pb-3">Alterando horário <kbd class="bg-dark">06:48</kbd>
			da estação <kbd class="bg-dark">Natal</kbd> com estação inicial <kbd
				Natal class="bg-dark">Natal</kbd> e estação final <kbd
				class="bg-dark">Ceará-Mirim</kbd>, válido de <kbd>segunda-feira</kbd>
			a <kbd>sábado</kbd>.
		</label>
		...
		<div class="col-md-7">
			<form action="stations.jsp">
				<div class="form-group row">
					<label for="inputPassword" class="col-sm-3 col-form-label">Estação:</label>
					<div class="col-sm-9">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
						<select class="form-control" id="exampleFormControlSelect1">
							<option>Natal -> Ceará-Mirim</option>
							<option>Ceará-Mirim -> Natal</option>
