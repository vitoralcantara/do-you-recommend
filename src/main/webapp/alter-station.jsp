...
<body>
	<div class="pb-2 mt-4 mb-4 border-bottom title">
		<label class="lb-lg">Alterar estação</label>
		<button class="btn btn-danger float-right btn-sm button-new">Remover estação</button>
	</div>

	<div class="col-md-4  justify-content-center titleLike">

		<label class="pb-3">Alterando estação <kbd class="bg-dark">Alecrim I</kbd>.</label>
